...
if __name__ == "__main__":
    ...
    parser.add_argument("--repeat", default=60, type=int, help="繰り返しのインターバル[min](未実装)")  # min
    parser.add_argument("--addDays", default=[], nargs="*", type=int,help="追加したい日付スペース区切りで羅列.(ex: 10 31)")  # 日付のリスト
